...
namespace BleakwindBuffet.DataTests.UnitTests.SideTests
{
    ...
    public class MadOtarGritsTests
    {
        ...
        /// <summary>
        /// Tests if Mad Otar Grits implements INotifyPropertyChanged.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Tests if Mad Otar Grits notifies of Size change.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Tests if Mad Otar Grits notifies of Price change.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Tests if Mad Otar Grits notifies of Calories change.
        /// </summary>
        [Fact]
        ...
        public void ShouldHaveCorrectDescription(Size size)
        {
            ...
            MadOtarGrits mog = new MadOtarGrits();
            mog.Size = size;
            Assert.Equal(expected, mog.Description);
        }
    }
}